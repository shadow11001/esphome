...
# This matches the C++ inheritance: public PollingComponent, public display::DisplayBuffer
...
async def to_code(config):
    ...
    # Library dependency handled by platformio.ini environment
    # cg.add_library("vroland/epdiy", "^1.0.0")
